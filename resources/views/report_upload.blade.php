                        ...
                        <div class="border-with-text" data-heading="Journalist Information">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="col-md-3"> 
                                            ...
                                            <option disbled value="">Select</option>
    ...
    fetch(imageUrl)
        ...
        .then(blob => {
            ...
            reader.onloadend = function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'https://vision.googleapis.com/v1/images:annotate?key=AIzaSyDrKnIFPDRO92kSKJioN7LxBckPqQQ51MY',
                    ...
                    success: function(response) {
                        if (response && response.responses && response.responses.length > 0) {
                            if (response.responses[0].textAnnotations && response.responses[0].textAnnotations.length > 0) {
                                ...
                                data2 +='<input type="number" name="page_no' + index + '" class="form-control" placeholder="page no">';
