                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="mail_template_id" value="{{ $mail_template ? $mail_template->mail_template_id : '' }}">
                                            ...
                                            <select class="form-control" name="trackify_media" required>
                                                ...
                                                <option <?php echo (isset($mail_template) && $mail_template->trackify_link_status == '1') ? 'selected' : ''; ?> value="1">Yes</option>
                                                <option <?php echo (isset($mail_template) && $mail_template->trackify_link_status == '0') ? 'selected' : ''; ?> value="0">No</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="menu_bg_color">Trackify Link</label>
                                            <input type="text" oninput="removeLeadingSpace(this)" class="form-control" value="{{ old('trackify_link', isset($mail_template) ? $mail_template->trackify_link : '') }}" name="trackify_link" placeholder="Trackify Link" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="menu_bg_color">Header Background Color</label>
                                            <input type="color" class="form-control" name="menu_bg_color"  value="{{ old('menu_bg_color', isset($mail_template) ? $mail_template->menu_background_color : '') }}" placeholder="Background Color" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="header_bg_color">Header Font Color</label>
                                            <input type="color" class="form-control" name="menu_font_color" placeholder="Header Font Color" value="{{ old('menu_font_color', isset($mail_template) ? $mail_template->menu_font_color : '') }}" required>
                                        </div>
                                        <div class="col-md-3">
...
<option <?php echo (isset($mail_template) && $mail_template->menu_font == 'Times New Roman') ? 'selected' : ''; ?> value="Times New Roman">Times New Roman</option>
...
<option <?php echo (isset($mail_template) && $mail_template->menu_font == 'Verdana') ? 'selected' : ''; ?> value="Verdana">Verdana</option>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select name="header_font_size" class="form-control" id="HTBFontSize1" required>
                                                            ...
                                                            <option <?php echo (isset($mail_template) && $mail_template->menu_font_size == '1') ? 'selected' : ''; ?> value="1">1</option>
                                                                ...
                                                                <option <?php echo (isset($mail_template) && $mail_template->menu_font_size == '18') ? 'selected' : ''; ?> value="18">18</option>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="color" class="form-control" name="row_background" placeholder="Row Background " value="{{ old('menu_row_background', isset($mail_template) ? $mail_template->menu_row_background : '') }}" required>
                                        </div> 
                                        <div class="col-md-2">
                                            <label class="px-1 font-weight-bold" for="font_color">Row Font Color</label>
                                            <input type="color" class="form-control" name="row_font_color" placeholder="Row Font Color" value="{{ old('row_font_color', isset($mail_template) ? $mail_template->menu_row_font_color : '') }}" required>
                                        </div>
                                        <div class="col-md-2">
...
<option <?php echo (isset($mail_template) && $mail_template->menu_row_font == 'Times New Roman') ? 'selected' : ''; ?> value="Times New Roman">Times New Roman</option>
...
<option <?php echo (isset($mail_template) && $mail_template->menu_row_font_Size == '18') ? 'selected' : ''; ?> value="18">18</option>
...
<option <?php echo (isset($mail_template) && $mail_template->menu_row_font_Size == '20') ? 'selected' : ''; ?> value="20">20</option>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select name="no_news_text" class="form-control" id="HTBFontSize1" required>
                                                            <option value="">Select</option>
                                                            <option <?php echo (isset($mail_template) && $mail_template->menu_no_news_text == 'Yes') ? 'selected' : ''; ?>  value="Yes">Yes</option>
                        ...
                        <div class="border-with-text" data-heading="Header Information">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="color" class="form-control" name="header_bg_color" placeholder="Background Color" value="{{ old('header_bg_color', isset($mail_template) ? $mail_template->header_background_color : '') }}" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="logo_url">Logo Url</label>
                                            <input type="text" oninput="removeLeadingSpace(this)" class="form-control" name="logo_url" placeholder="Logo Url" value="{{ old('logo_url', isset($mail_template) ? $mail_template->header_logo_url : '') }}" required>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" name="logo_position" required>
                                                <option value="">Select</option>
                                                <option <?php echo (isset($mail_template) && $mail_template->logo_position == 'Left') ? 'selected' : ''; ?> value="Left">Left</option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" oninput="removeLeadingSpace(this)" name="title_name" placeholder="Title Name" value="{{ old('title_name', isset($mail_template) ? $mail_template->header_title_name : '') }}" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="font_color">Title Font Color</label>
                                            <input type="color" class="form-control"  name="font_color" placeholder="Font Color" value="{{ old('font_color', isset($mail_template) ? $mail_template->header_title_font_color : '') }}" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="font_color">Title Font Size</label>
                                            <input type="number" oninput="removeLeadingSpace(this)" class="form-control" name="font_size" placeholder="Font Size"value="{{ old('font_size', isset($mail_template) ? $mail_template->header_title_font_size : '') }}" required>
                                        </div>
...
<script>
    ...
    // });
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="color" class="form-control" placeholder="Enter Summary Color" name="content_news_summary_color" value="{{ old('content_news_summary_color', isset($mail_template) ? $mail_template->content_news_summary_color : '') }}" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="media_type">News Summary Font Size</label>
                                            <input type="number" oninput="removeLeadingSpace(this)" class="form-control" placeholder="Enter Font Size" name="content_news_summary_color_size" value="{{ old('content_news_summary_color_size', isset($mail_template) ? $mail_template->content_news_summary_font_size : '') }}" required>
                                        </div>
                                       
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="media_type">Headline Color </label>
                                            <input type="color" class="form-control" placeholder="Enter Headline Color" name="content_headline_color" value="{{ old('content_headline_color', isset($mail_template) ? $mail_template->content_headline_color : '') }}" required>
                                        </div>
                                        <div class="col-md-3">
...
<option <?php echo (isset($mail_template) && $mail_template->content_headline_font == 'Times New Roman') ? 'selected' : ''; ?> value="Times New Roman">Times New Roman</option>
...
<option <?php echo (isset($mail_template) && $mail_template->content_headline_font == 'Verdana') ? 'selected' : ''; ?> value="Verdana">Verdana</option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" oninput="removeLeadingSpace(this)" class="form-control" placeholder="Enter Font Size " name="headline_font_size" required value="{{ old('headline_font_size', isset($mail_template) ? $mail_template->content_headline_font_size : '') }}">
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <option <?php echo (isset($mail_template) && $mail_template->content_media_details == 'Yes') ? 'selected' : ''; ?> value="Yes">Yes</option>
                                            <option <?php echo (isset($mail_template) && $mail_template->content_media_details == 'No') ? 'selected' : ''; ?> value="No">No</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="media_type">Media Color </label>
                                            <input type="color" class="form-control" placeholder="Enter Media Color" name="media_color" required value="{{ old('media_color', isset($mail_template) ? $mail_template->content_media_color : '') }}">
                                        </div>
                                        <div class="col-md-3">
...
<option <?php echo (isset($mail_template) && $mail_template->content_media_font == 'Times New Roman') ? 'selected' : ''; ?> value="Times New Roman">Times New Roman</option>
...
<option <?php echo (isset($mail_template) && $mail_template->content_media_font == 'Verdana') ? 'selected' : ''; ?> value="Verdana">Verdana</option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" oninput="removeLeadingSpace(this)" class="form-control" placeholder="Enter Font Size" name="media_font_size" required value="{{ old('media_font_size', isset($mail_template) ? $mail_template->	content_media_font_size : '') }}">
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <option value="0">Select</option>
                                            <option value="Yes" <?php echo (isset($mail_template) && $mail_template->content_context == 'Yes') ? 'selected' : ''; ?> >Yes</option>
                                            <option value="No"  <?php echo (isset($mail_template) && $mail_template->content_context == 'No') ? 'selected' : ''; ?>>No</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3">
...
<option value="Times New Roman" <?php echo (isset($mail_template) && $mail_template->content_context_font == 'Times New Roman') ? 'selected' : ''; ?>>Times New Roman</option>
...
<option value="Verdana" <?php echo (isset($mail_template) && $mail_template->content_context_font == 'Verdana') ? 'selected' : ''; ?>>Verdana</option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" oninput="removeLeadingSpace(this)" class="form-control" placeholder="Context Font Size" name="context_font_size" required value="{{ old('context_font_size', isset($mail_template) ? $mail_template->content_context_font_size : '') }}">
                                        </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="border-with-text" data-heading="Footer Information">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="color" class="form-control" name="footer_bg_color" placeholder="Background Color" required value="{{ old('footer_bg_color', isset($mail_template) ? $mail_template->footer_background_color : '') }}">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="logo_url">Logo Url</label>
                                            <input type="text" oninput="removeLeadingSpace(this)" class="form-control" name="footer_logo_url" placeholder="Logo Url" required value="{{ old('footer_logo_url', isset($mail_template) ? $mail_template->footer_logo_url : '') }}">
                                        </div>
                                        <div class="col-md-3">
                                        <label class="px-1 font-weight-bold" for="logo_position">Logo Position</label>
                                         <select class="form-control" name="footer_logo_position" required>
                                         <option value="">Select</option>
                                         <option value="Left" <?php echo (isset($mail_template) && $mail_template->footer_logo_position == 'Left') ? 'selected' : ''; ?>>Left</option>
                                        <option value="Right" <?php echo (isset($mail_template) && $mail_template->footer_logo_position == 'Right') ? 'selected' : ''; ?>>Right</option>
                                        <option value="Center" <?php echo (isset($mail_template) && $mail_template->footer_logo_position == 'Center') ? 'selected' : ''; ?>>Center</option>
                                        </select>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="title_name">Title Name</label>
                                            <input type="text" oninput="removeLeadingSpace(this)" class="form-control" name="footer_title_name" placeholder="Title Name" required value="{{ old('footer_title_name', isset($mail_template) ? $mail_template->footer_title_name : '') }}">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="font_color">Title Font Color</label>
                                            <input type="color" class="form-control" name="footer_font_color" placeholder="Font Color" required value="{{ old('footer_font_color', isset($mail_template) ? $mail_template->footer_title_font_color : '') }}">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="px-1 font-weight-bold" for="font_color">Title Font Size</label>
                                            <input type="number" oninput="removeLeadingSpace(this)" class="form-control" name="footer_font_size" placeholder="Font size"required value="{{ old('footer_font_size', isset($mail_template) ? $mail_template->footer_title_font_size : '') }}">
                                        </div>
                                    </div>
                         </div>
                    </div>
