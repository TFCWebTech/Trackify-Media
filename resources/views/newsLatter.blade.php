...
@endif
        ...
        <div class="card" id="content" style="background-color: #F9F9F9;">
                ...
                <div class="body-content" style="padding:10px 15px 0px 15px;"  id="clientdiv">
                    <h4 style="background-color: #cfbbbb; color: #ffffff; padding:4px;text-align: center;"> {{ $details['client_name'] }} </h4>
                ...
                <div class="body-content" style="padding:10px 15px 0px 15px;">
                    <h4 style="background-color: #cfbbbb; color: #ffffff; padding:4px;text-align: center;">Competition</h4>
                </div>
                ...
                <div class="body-content" style="padding:10px 15px 0px 15px;">
                    <h4 style="background-color: #cfbbbb; color: #ffffff; padding:4px;text-align: center;"> Industry</h4>
                </div>
